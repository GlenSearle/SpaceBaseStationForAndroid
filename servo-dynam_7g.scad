ServoBody=[22.2,11.2,14.4];
FlangeToBottom=ServoBody[2];
Flange=[29.1,7.5,0.8];
FlangeBevel=1;
AxleOffset=5;
...
cube([ServoBody[0]+(ServoPadding*2),ServoBody[1]+(ServoPadding*2),ServoBody[2]+HeighAboveFlange]);
...
cylinder(r=ServoBody[1]/2, h=10); //spindle
translate([-AxleOffset-ServoBody[1], -ServoBody[1]/2, 0.00 ])
 cube(ServoBody[1]);
}
translate([ ServoBody[1]/2, 0.00, 0.00 ]) cylinder(r=4.5/2, h=10);
//translate([ ServoBody[1]/2+3.5, 0.00, 0.00 ]) cylinder(r=2.2/2, h=7);
}
